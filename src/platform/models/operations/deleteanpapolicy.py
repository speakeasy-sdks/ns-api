...
@dataclasses.dataclass
class DeleteANpaPolicy200ApplicationJSONDataRuleDataMatchCriteriaAction:
...
@dataclasses.dataclass
class DeleteANpaPolicy200ApplicationJSONDataRuleDataPrivateAppsWithActivitiesActivities:
...
@dataclasses.dataclass
class DeleteANpaPolicy200ApplicationJSONDataRuleDataPrivateAppsWithActivities:
    activities: Optional[list[DeleteANpaPolicy200ApplicationJSONDataRuleDataPrivateAppsWithActivitiesActivities]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('activities'), 'exclude': lambda f: f is None }})
...
@dataclasses.dataclass
class DeleteANpaPolicy200ApplicationJSONDataRuleData:
    ...
    match_criteria_action: Optional[DeleteANpaPolicy200ApplicationJSONDataRuleDataMatchCriteriaAction] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('match_criteria_action'), 'exclude': lambda f: f is None }})
    ...
    private_apps_with_activities: Optional[list[DeleteANpaPolicy200ApplicationJSONDataRuleDataPrivateAppsWithActivities]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('privateAppsWithActivities'), 'exclude': lambda f: f is None }})
...
@dataclasses.dataclass
class DeleteANpaPolicy200ApplicationJSONData:
    ...
    rule_data: Optional[DeleteANpaPolicy200ApplicationJSONDataRuleData] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rule_data'), 'exclude': lambda f: f is None }})
...
@dataclasses.dataclass
class DeleteANpaPolicy200ApplicationJSON:
    r"""successful operation"""
    data: Optional[DeleteANpaPolicy200ApplicationJSONData] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
...
@dataclasses.dataclass
class DeleteANpaPolicyResponse:
    content_type: str = dataclasses.field()
    r"""HTTP response content type for this operation"""
    status_code: int = dataclasses.field()
    r"""HTTP response status code for this operation"""
    delete_a_npa_policy_200_application_json_object: Optional[DeleteANpaPolicy200ApplicationJSON] = dataclasses.field(default=None)
    r"""successful operation"""
